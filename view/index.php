            ...
            <div class="widget-label">
              ...
              <h1>
                <?php 
                  ...
                  $sql_data_customer = mysqli_query($koneksi2,"SELECT * FROM customer");
                  $jumlah_customer = mysqli_num_rows($sql_data_customer);
                  echo $jumlah_customer;
                ?>
              </h1>
            </div>
        ...
        <div class="card-content">
          <div class="flex items-center justify-between">
            <div class="widget-label">
              ...
              <h1>
                <?php 
                  $sql_data_transaksi= mysqli_query($koneksi2,"SELECT * FROM transaksi");
                  // $total_pembelian = array_sum($sql_data_transaksi);
                  foreach($sql_data_transaksi as $isi){
                    $total_pembelian[]= $isi['total_pembelian'];
                  }
                  $hasil_total_pembelian = array_sum($total_pembelian);
                  echo $hasil_total_pembelian;
                ?>
              </h1>
            </div>
              ...
              <div class="card-body">
                <table class="table table-hover table-bordered" id="mytable" style="margin-top: 10px">
                  ...
                  <tbody>
                     <?php
                        $no=1;
                        $hasil = $ObjDataCustomer->tampil_data('customer');
                    ...
                    <td><?php echo $isi['email_customer'];?></td>
                    <td><?php echo $isi['username_customer'];?></td>
                    <td>************</td>
                      <td style="text-align: center;">
                        <a href="EditDataCustomer.php?id=<?php echo $isi['id_customer'];?>" class="button green">
                          <span class="fa fa-edit"></span>
                        </a>
                        <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="../proses/CRUD_DataCustomer.php?aksi=hapus&hapusid=<?php echo $isi['id_customer'];?>" class="button red">
                ...
                <br>
                <a href="TambahCustomer.php" class="btn btn-success btn-md">
