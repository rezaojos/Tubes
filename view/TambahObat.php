  ...
  <section class="section main-section">
    <div class="card mb-6">
      ...
      <div class="card-content">
        <form action="../proses/CRUD_DataObat.php?aksi=tambah" enctype="multipart/form-data" method="POST">
          <div class="field">
            <label class="label">ID Obat</label>
            <div class="control">
              <input name="id_obat" class="input" type="text" placeholder="e.g. B0001" required>
            </div>
          </div>
          <div class="field">
            <label class="label">Nama Obat</label>
            <div class="control">
              <input name="nama_obat" class="input" type="text" placeholder="e.g. Alphazolam" required>
            </div>
          </div>
          <div class="field">
            <label class="label">Stok</label>
            <div class="control">
              <input name="stok" class="input" type="text" placeholder="e.g. 100" required>
            </div>
          </div>
          <div class="field">
          ...
          <div class="field">
            ...
            <div class="control">
              <textarea name="ket_obat" class="textarea" placeholder="Keterangan Obat yang ingin ditambahkan" required></textarea>
            </div>
          </div>
