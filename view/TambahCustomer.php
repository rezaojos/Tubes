  ...
  <section class="section main-section">
    <div class="card mb-6">
      ...
      <div class="card-content">
        <form action="../proses/CRUD_DataCustomer.php?aksi=tambah" method="POST">
          <!-- <div class="field">
            <label class="label">ID Customer</label>
            <div class="control">
              <input name="id_customer" class="input" type="text" placeholder="e.g. 1,2,3" required>
            </div>
          </div> -->
          <div class="field">
            <label class="label">Nama Customer</label>
            <div class="control">
              <input name="nama_customer" class="input" type="text" placeholder="e.g. Wawan" required>
            </div>
          </div>
          <div class="field">
            <label class="label">Email Customer</label>
            <div class="control">
              <input name="email_customer" class="input" type="email" placeholder="e.g. wawanz@gmail.com" required>
            </div>
          </div>
          <div class="field">
            <label class="label">Username</label>
            <div class="control">
              <input name="username_customer" class="input" type="text" placeholder="e.g. Wawanz" required>
            </div>
          </div>
          <div class="field">
            <label class="label">Password</label>
            <div class="control">
              <input name="password_customer" class="input" type="password" placeholder="e.g. *****" required>
            </div>
          </div>
