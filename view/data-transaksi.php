              ...
              <div class="card-body">
                <table class="table table-hover table-bordered" id="mytable" style="margin-top: 10px">
                  ...
                  <tbody>
                    <?php
                      $no=1;
                      $hasil = $ObjDataTransaksi->tampil_data('transaksi');
                    ...
                    <tr>
                      ...
                      <td><?php echo "<img alt='belum membayar' src='../../user_page/view/images/bukti_pembayaran/$isi[bukti_pembayaran]' width='100'/>";?></td>
                      <td><?php echo $isi['status'];?></td>
                      <td style="text-align: center;">
                        <a href="EditDataTransaksi.php?id=<?php echo $isi['id_transaksi'];?>" class="button green">
                          <span class="fa fa-check"></span>
                        </a>
                        <!-- <form class="button green" method="POST" action="../proses/CRUD_DataTransaksi.php?aksi=edit">
                          <input type="text" name="status" value="approve"> </input>
                          <input type="text" name="status" value="approve"> </input>
