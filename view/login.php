  ...
  <section class="section main-section">
    <div class="card">
      ...
      <div class="card-content">
        <form method="POST" action="../proses/CRUD_LoginLogout.php?aksi=login" id="formlogin">
          <div id="logout">
          ...
          <div class="field spaced">
            ...
            <div class="control icons-left">
              <input class="input" type="text" name="user" placeholder="wawan" autocomplete="username">
          ...
          <div class="field grouped">
            <div class="control">
              <button name="proses_login" type="submit" class="button blue">
                Login
              </button>
            </div>
            <div class="control">
