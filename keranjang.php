            ...
            <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Rp15.000</td>
                    <td> 
						<input type="number" value="1" class="form-control input-kuantitas"></td>
            <td>Rp15.000</td>
            <td>
              <a href="#" class="btn btn-outline-success rounded-circle btn-tambah">
                <img src="img/bin.png" alt="" width="30" height="30">
              </a>
            </td>
                  </tr>
                  <tr>
                ...
                <div class="col-md-5 ms-auto">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <td colspan="2">
                          <a href="transaksi.php" onclik = "window.print" class="btn btn-lg btn-success w-100">Report</a>
                        </td>
                      </tr>
                    </table>
                  </div>
