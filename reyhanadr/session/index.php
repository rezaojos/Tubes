<?php
  ...
  if(isset($_POST['login'])){
    ...
    if($username){
        ...
        header("location:index.php?pesan=notregister");
    }
  }
?>
        ...
        <form method="POST">
          ...
          <div class="field spaced">
            ...
            <div class="control icons-left">
              <input class="input" type="text" name="login" placeholder="Username" autocomplete="username">
          ...
          <div class="field grouped">
            <div class="control">
              <input type="submit" name="login" value="Login" class="button blue"> </input>
            </div>
            <div class="control">
